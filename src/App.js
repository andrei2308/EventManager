...
function App() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await axios.post(
        `https://eventmanager-1-l2dr.onrender.com/login`,
        { username, password },
      );
  ...
  const handleRegister = async (e) => {
    ...
    setIsLoading(true);
    try {
      await axios.post(`https://eventmanager-1-l2dr.onrender.com/register`, {
        username,
        password,
        email,
      });
    ...
    <ThemeProvider theme={theme}>
      <Router>
        <Routes>
          ...
          <Route
            path="/events/details/admin/:eventId"
            element={<AdminEventsDetails />}
          />
          <Route path="/groups/:userId" element={<AdminGroups />} />
          <Route
            path="/groups/details/admin/:groupId"
            element={<AdminEventsFromGroup />}
          />
