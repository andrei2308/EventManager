...
export function AdminEvents() {
  ...
  useEffect(() => {
    ...
    axiosInstance
      .get(`https://eventmanager-1-l2dr.onrender.com/events/admin/${userId}`)
      .then((response) => {
  ...
  return (
    <Box
      sx={{
        padding: 3,
        backgroundColor: "#f5f7fa", // Light blue background for contrast
        minHeight: "100vh",
      }}
    >
      <Typography
        ...
        gutterBottom
        sx={{
          color: "#1565c0", // Blue heading color
          fontWeight: "bold",
          textAlign: "center",
            ...
            <Grid item xs={12} sm={6} md={4} key={event._id}>
              <Card
                ...
                sx={{
                  ...
                  border:
                    index % 2 === 0 ? "2px solid #90caf9" : "2px solid #bbdefb", // Alternating light blue borders
                  "&:hover": {
                    boxShadow: "0px 6px 12px rgba(0, 0, 0, 0.2)", // Shadow effect on hover
                    borderColor: index % 2 === 0 ? "#42a5f5" : "#64b5f6", // Darker border on hover
                  },
                ...
                <CardContent>
                  ...
                  <Typography
                    ...
                    sx={{
                      ...
                      backgroundColor:
                        event.status === "CLOSED" ? "#e8f5e9" : "#ffebee", // Light green/red background
                      fontWeight: "bold",
                      padding: "4px 8px",
                      borderRadius: 2,
