...
export * from 'undici-types/cache'undici - types / mock - interceptorptable } from './mock-interceptor'
...
declare namespace Undiundici-types / dispatcherDispatcher: typeof import('undici-types/dispatcheundici-types/poolfaultt
  var Pool: typeof import('undici-types/pool').default; undici - types / handlersdirectHandler: typeof import('undici-types/handlers').RedirectHandlerundici - types / handlerscoratorHandler: typeof import('undici-types/handlers').DecoratorHaundici - types / retry - handlertryHandler: typeof import('undici-types/retry-handler').default
varundici - types / interceptorstInterceptor: typeof import('undici-types/interceptors').default.createRedirectIntundici - types / balanced - pool BalancedPool: typeof import('undici-types/balanced-undici-types/clientefault;;
  var Client: typeof import('undici-types/client').undici-types / connector var buildConnector: typeof import('undici-types/conundici-types/errors.default;;
  var errors: typeof import('undici-types/agents').default;
var Agent: typeof import('undici-types/agent').deundici-types / global - dispatcherobalDispatcher: typeof import('undici-types/global-dispatcher').setGlobalDispundici - types / global - dispatcherlobalDispatcher: typeof import('undici-types/global-dispatcher').undici - types / apiobalDispatcher;
...
var FormData: undici-types / file import('undici-types/formdata').FormData;
